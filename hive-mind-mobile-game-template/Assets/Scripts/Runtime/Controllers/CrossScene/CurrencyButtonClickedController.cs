...
{
    public sealed class CurrencyButtonClickedController : Controller<CurrencyModel, CurrencySettings, CurrencyView>
    {
        ...
        #region Constructor
        public CurrencyButtonClickedController(CurrencyModel model, CurrencyView view, SignalBus signalBus) :
