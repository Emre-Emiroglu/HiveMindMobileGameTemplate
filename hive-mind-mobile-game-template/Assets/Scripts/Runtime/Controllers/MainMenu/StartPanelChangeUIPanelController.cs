...
{
    public sealed class StartPanelChangeUIPanelController : Controller<MainMenuModel, MainMenuSettings, StartPanelView>
    {
        ...
        #region Constructor
        public StartPanelChangeUIPanelController(MainMenuModel model, StartPanelView view, LevelModel levelModel) :
