...
{
    public sealed class ShopPanelHomeButtonClickedController : Controller<MainMenuModel, MainMenuSettings, ShopPanelView>
    {
        ...
        #region Constructor
        public ShopPanelHomeButtonClickedController(MainMenuModel model, ShopPanelView view, SignalBus signalBus) :
