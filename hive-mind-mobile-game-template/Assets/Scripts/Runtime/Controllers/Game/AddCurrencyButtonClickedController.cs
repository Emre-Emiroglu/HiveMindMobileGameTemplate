...
{
    public sealed class AddCurrencyButtonClickedController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public AddCurrencyButtonClickedController(GameModel model, InGamePanelView view, SignalBus signalBus) :
