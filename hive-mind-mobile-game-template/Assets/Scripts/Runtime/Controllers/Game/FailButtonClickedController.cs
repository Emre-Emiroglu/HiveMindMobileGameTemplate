...
{
    public sealed class FailButtonClickedController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public FailButtonClickedController(GameModel model, InGamePanelView view, SignalBus signalBus) : base(model,
