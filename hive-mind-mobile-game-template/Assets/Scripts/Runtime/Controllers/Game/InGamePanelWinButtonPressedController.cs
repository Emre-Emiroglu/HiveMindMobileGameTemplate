...
{
    public sealed class InGamePanelWinButtonPressedController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public InGamePanelWinButtonPressedController(GameModel model, InGamePanelView view, SignalBus signalBus) :
