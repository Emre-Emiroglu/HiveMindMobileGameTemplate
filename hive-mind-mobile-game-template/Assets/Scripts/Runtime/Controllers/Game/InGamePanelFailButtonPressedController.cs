...
{
    public sealed class InGamePanelFailButtonPressedController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public InGamePanelFailButtonPressedController(GameModel model, InGamePanelView view, SignalBus signalBus) :
