...
{
    public sealed class WinButtonClickedController : Controller<GameModel, GameSettings, InGamePanelView>
    {
        ...
        #region Constructor
        public WinButtonClickedController(GameModel model, InGamePanelView view, SignalBus signalBus) : base(model,
